        ...
        <div className="w-full max-w-[380px] rounded-xl border border-[#E5E7EB] bg-white p-8 shadow-sm">
          ...
          <ul className="mt-5 space-y-2.5">
            {FEATURES.map((line) => (
              <li
                key={line}
                className="flex gap-2 text-sm leading-snug text-[#374151]"
              >
                <Check
          ...
          <div className="mt-6 border-t border-[#E5E7EB] pt-5 text-center">
            ...
            <p className="text-muted-marketing mt-1">
          ...
          <button
            ...
            onClick={onUnlock}
            disabled={loading}
            className="mt-6 flex w-full items-center justify-center gap-2 rounded-lg bg-primary px-5 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-primary-dark disabled:cursor-wait disabled:opacity-70"
          >
            {loading ? (
              <>
