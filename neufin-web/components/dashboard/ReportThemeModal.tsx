...
export function ReportThemeModal({ onSelect, onClose }: ReportThemeModalProps) {
  ...
  return (
    ...
    >
      <div
        style={{
          background: '#161D2E', border: '1px solid #2A3550',
        ...
        <div style={{ display: 'flex', gap: 16, marginTop: 24 }}>
          ...
          >
            <div style={{
              ...
              background: '#0B0F14', border: '1px solid #2A3550',
              marginBottom: 12, display: 'flex', flexDirection: 'column',
              gap: 6, padding: 10,
            }}>
              <div style={{ width: '70%', height: 6, background: '#1EB8CC', borderRadius: 3 }} />
              <div style={{ width: '90%', height: 4, background: '#2A3550', borderRadius: 2 }} />
              <div style={{ width: '60%', height: 4, background: '#2A3550', borderRadius: 2 }} />
          ...
          >
            <div style={{
              ...
              <div style={{ width: '70%', height: 6, background: '#0891B2', borderRadius: 3 }} />
              <div style={{ width: '90%', height: 4, background: '#CBD5E1', borderRadius: 2 }} />
