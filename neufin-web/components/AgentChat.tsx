...
export default function AgentChat({
  ...
  return (
    ...
    >
        ...
        <div style={{
          ...
          {SUGGESTED.map((s, i) => (
            <button
              ...
              onMouseEnter={e => { (e.target as HTMLButtonElement).style.borderColor = `${A}66`; (e.target as HTMLButtonElement).style.color = A }}
                  ...
                  <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 6 }}>
                    ...
                    {msg.keyNumbers && Object.keys(msg.keyNumbers).length > 0 && (
                      <div style={{
                        ...
                        padding: '5px 8px', display: 'flex', flexWrap: 'wrap', gap: '4px 16px',
                      }}>
      ...
      {/* Input */}
      <div style={{
        borderTop: `1px solid #1e1e1e`, padding: '8px 12px',
        ...
        <input
          ...
          style={{
            ...
            color: BODY, fontSize: 10, fontFamily: MONO,
            caretColor: A,
          }}
        />
        <button
