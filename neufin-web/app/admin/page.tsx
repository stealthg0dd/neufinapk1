    ...
    return (
      <div className="p-6 max-w-3xl">
        ...
        <p className="mt-2 text-sm text-zinc-500">
          Ensure NEXT_PUBLIC_API_URL points at the API and you are signed in as
          an admin.
        </p>
      </div>
    );
  ...
  return (
    <div className="p-6 space-y-6 max-w-6xl">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <MetricCard
          title="Active Trials"
          card={c.active_trials}
          color="#a78bfa"
        />
        <MetricCard
          title="Paying (count)"
          card={c.paying_mrr_proxy}
          color="#34d399"
        />
        <MetricCard
          title="Expired Users"
