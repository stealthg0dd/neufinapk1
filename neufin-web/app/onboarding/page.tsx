...
const ROLES = [
  {
    ...
    desc: "Managing my own portfolio",
  },
  {
    id: "advisor",
    label: "Financial Advisor / IFA",
    desc: "Managing portfolios for clients",
  },
  {
    id: "pm",
    label: "Portfolio Manager / PE",
    desc: "Institutional portfolio management",
  },
  {
    id: "enterprise",
    label: "Platform / B2B",
    desc: "Integrating NeuFin into my platform",
  },
];
    ...
    try {
      const res = await apiFetch("/api/profile/complete-onboarding", {
        ...
        body: JSON.stringify({
          ...
          advisor_name:
            (isAdvisorRole ? advisorName.trim() : name.trim()) || name.trim(),
          firm_name:
            isAdvisorRole && wantWhiteLabel ? firmName.trim() : undefined,
              ...
              {ROLES.map((r) => (
                <div
                  ...
                  style={{
                    ...
                    cursor: "pointer",
                    border:
                      role === r.id ? "2px solid #1EB8CC" : "1px solid #2A3550",
                    background: role === r.id ? "#0D1F2A" : "#0B0F14",
                  }}
                >
                  <div
                    style={{ color: "#F0F4FF", fontSize: 13, fontWeight: 500 }}
                  >
                    {r.label}
                  </div>
        ...
        {step === 2 && (
          <div>
            ...
            {isAdvisorRole ? (
              <>
                <p
                  style={{ color: "#64748B", fontSize: 13, margin: "0 0 24px" }}
                >
                  White-label NeuFin reports with your firm branding. Your
                ...
                <div
                  ...
                  onKeyDown={(e) => {
                    if (e.key === "Enter" || e.key === " ")
                      setWantWhiteLabel(!wantWhiteLabel);
                  }}
                  style={{
                    display: "flex",
                    alignItems: "center",
              ...
              <p style={{ color: "#94A3B8", fontSize: 13, margin: "0 0 24px" }}>
                You are set up as an individual investor. You can add firm
            ...
            >
              ...
              >
                {logoBase64 ? (
                  ...
                  <div
                    style={{ color: "#1EB8CC", fontWeight: 700, fontSize: 16 }}
                  >
              ...
              <div
                style={{ height: 1, background: "#2A3550", marginBottom: 12 }}
              />
              <div style={{ color: "#64748B", fontSize: 11 }}>
                Prepared by: {(advisorName || name).trim() || "You"} ·{" "}
                {firmName || "NeuFin Intelligence"}
              </div>
            </div>
