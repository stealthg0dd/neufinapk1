        ...
        <div className="max-w-6xl mx-auto px-6 py-section">
          ...
          <section className="card mb-20">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {[
                ['Prospect Theory', 'Losing SGD 10,000 feels twice as bad as gaining SGD 10,000 feels good — leading to irrational risk aversion.'],
                ['Disposition Effect', 'Selling winners too early, holding losers too long. Detected by comparing hold times for gaining vs losing positions.'],
                ['Home Country Bias', 'Over-concentration in SGX-listed securities. Flagged when SG equities exceed 40% of total holdings.'],
                ['Recency Bias', 'Overweighting recent market events — buying during rallies, panic-selling during corrections.'],
