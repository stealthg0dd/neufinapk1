...
const articleSchema = {
  ...
  keywords:
    "disposition effect, Singapore investors, behavioral finance, portfolio analysis, cognitive bias",
  inLanguage: "en-SG",
};
      ...
      <article>
        <div className="mb-8">
          <div className="flex flex-wrap gap-2 mb-4">
            {["Disposition Effect", "Singapore", "Behavioral Finance"].map(
              (t) => (
                <span
                  key={t}
          ...
          <h1 className="text-3xl font-extrabold leading-tight mb-4">
            The Disposition Effect Is Costing Singapore Investors — Here&apos;s
            the Data
          </h1>
        ...
        <p className="text-lg text-shell-fg/90 leading-relaxed mb-6 font-medium">
          Singapore investors hold losing positions an average of 2.3× longer
          than winning ones — a pattern called the Disposition Effect that costs
          affected portfolios an estimated 1.5–3% in annual returns. First
          documented by economists Shefrin and Statman in 1985 and grounded in
          Kahneman and Tversky&apos;s Prospect Theory, the Disposition Effect is
          among the most measurable and correctable behavioral biases. NeuFin,
          founded 2025 in Singapore, detects it directly from your transaction
          data via Plaid API. This guide explains what it is, what it costs, and
        ...
        <section className="mb-8">
          ...
          <p className="text-shell-muted leading-relaxed mb-4">
            The term was coined by Hersh Shefrin and Meir Statman in their
            landmark 1985 paper, &quot;The Disposition to Sell Winners Too Early
            and Ride Losers Too Long: Theory and Evidence.&quot; They observed
            that investors are systematically disposed to realise gains quickly
            while deferring the realisation of losses — the opposite of what
            tax-efficient, return-maximising investing recommends.
          </p>
          <p className="text-shell-muted leading-relaxed">
            The psychological mechanism is Prospect Theory (Kahneman &amp;
            Tversky, 1979): losses are felt approximately twice as intensely as
            equivalent gains. Holding a losing position allows the investor to
            avoid the emotional pain of &quot;officially&quot; losing money,
            while selling a winner provides immediate psychological reward. Both
            responses are emotionally rational but financially destructive.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-shell-muted leading-relaxed mb-4">
            NeuFin&apos;s analysis of anonymised Singapore investor portfolios
            (January–December 2024) finds:
          </p>
          <ul className="space-y-3 mb-4">
            {[
              ...
              <li
                key={item}
                className="flex items-start gap-2 text-shell-muted text-sm"
              >
          ...
          <p className="text-shell-muted leading-relaxed">
            The REIT finding is notable: Singapore REITs are often characterised
            as &quot;safe, income-generating assets,&quot; which reduces
            psychological permission to cut losses — a narrative-driven
            amplifier of the Disposition Effect.
          </p>
        </section>

        <section className="mb-8">
          <h2 className="text-xl font-bold mb-3">
            How to Detect the Disposition Effect in Your Portfolio
          </h2>
          <p className="text-shell-muted leading-relaxed mb-4">
            The quantitative measure used in academic research is the PGR/PLR
            ratio (Odean, 1998): Proportion of Gains Realised divided by
            Proportion of Losses Realised. A ratio significantly above 1.0
            indicates Disposition Effect.
          </p>
          <p className="text-shell-muted leading-relaxed mb-4">
            Without a tool like NeuFin, you can estimate it manually: look at
            your last 20 closed positions. Count how many were sold at a gain
            within 6 months (PGR) vs. how many losing positions you still hold
            after 12 months (PLR). If your winners clear faster than your
            losers, Disposition Effect is present.
          </p>
          <p className="text-shell-muted leading-relaxed">
            NeuFin automates this calculation across your full portfolio history
            via Plaid API — producing a Disposition Effect sub-score within your
            overall
            <strong className="text-shell-fg/90"> Investor DNA Score</strong>,
            with position-level breakdown showing exactly which holdings are
            most affected.
          </p>
        </section>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-3">
            How to Correct the Disposition Effect
          </h2>
          <p className="text-shell-muted leading-relaxed mb-4">
            Research consistently shows that behavioral awareness reduces the
            Disposition Effect by 25–40%. Beyond awareness, three evidence-based
            strategies work:
          </p>
          <div className="space-y-4">
            {[
              ...
              <div
                key={title}
                className="rounded-lg border border-shell-border bg-shell/50 p-4"
              >
        ...
        <div className="mt-12 rounded-2xl border border-primary/20 bg-primary/5 p-8">
          <h2 className="text-xl font-bold mb-2">
            Measure Your Disposition Effect Score
          </h2>
          <p className="text-shell-muted text-sm mb-5">
            NeuFin calculates your PGR/PLR ratio and Disposition Effect score
            from your actual portfolio data. Free. No account required.
          </p>
