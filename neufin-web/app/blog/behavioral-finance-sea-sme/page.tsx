...
export const metadata: Metadata = {
  title: 'Behavioral Finance for SEA SMEs: The 6 Biases Costing Singapore Businesses Money',
  description:
...
const articleSchema = {
  ...
  about: ['Behavioral Finance', 'Singapore SME', 'Cognitive Bias', 'Investment Psychology'],
  keywords: 'behavioral finance Singapore, investment bias SME, fintech Singapore, cognitive bias investing',
  inLanguage: 'en-SG',
}
    ...
    <>
      ...
      <article>
        ...
        <p className="text-lg text-shell-fg/90 leading-relaxed mb-6 font-medium">
          ...
          CFOs in Southeast Asia. NeuFin, founded in 2025 in Singapore, has analysed
          thousands of SME portfolios via Plaid API integration and identified six recurring
          bias patterns. This guide explains each bias, its measurable cost, and how to
        ...
        <section className="mb-8">
          ...
          <p className="text-shell-muted leading-relaxed">
            ...
            domains. A CFO who panic-sells during a correction (Recency Bias) and holds
            underperforming positions (Disposition Effect) may lose 15–20% more than a
        ...
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-6">The 6 Cognitive Biases Costing SEA SMEs Money</h2>
          ...
          <div className="space-y-8">
            ...
            <div className="rounded-xl border border-shell-border bg-shell/50 p-5">
              ...
              <p className="text-shell-muted leading-relaxed">
                ...
                your last five portfolio changes — were they all aligned with the market
                direction of the prior 30 days?
              </p>
            </div>
            ...
            <div className="rounded-xl border border-shell-border bg-shell/50 p-5">
              ...
              <p className="text-shell-muted leading-relaxed">
                ...
                overconfidence via trading frequency, position concentration, and Sharpe ratio
            ...
            <div className="rounded-xl border border-shell-border bg-shell/50 p-5">
              ...
              <p className="text-shell-muted leading-relaxed">
                ...
                Singapore-domiciled funds exceed 40% of total equity holdings, and provides
                a diversification roadmap with specific regional rebalancing suggestions.
              </p>
            </div>
            ...
            <div className="rounded-xl border border-shell-border bg-shell/50 p-5">
              ...
              <p className="text-shell-muted leading-relaxed">
                ...
                drift against your original allocation target and alerts you when drift
                exceeds a configurable threshold (default: 10 percentage points).
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-shell-muted leading-relaxed mb-4">
            ...
            AI analysis (Anthropic Claude, OpenAI GPT-4, Google Gemini) across your full
          ...
          <p className="text-shell-muted leading-relaxed mb-6">
            ...
            Effect showing the highest deviations from optimal behavior.
          </p>
