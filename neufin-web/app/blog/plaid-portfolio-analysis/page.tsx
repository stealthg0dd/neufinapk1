...
const articleSchema = {
  ...
  keywords:
    "Plaid Singapore, portfolio analysis cognitive bias, behavioral finance analysis, investment bias test Singapore",
  inLanguage: "en-SG",
};
      ...
      <article>
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-extrabold leading-tight mb-4">
            How to Analyse Your Investment Portfolio for Cognitive Biases
            (Singapore Guide)
          </h1>
        ...
        <p className="text-lg text-shell-fg/90 leading-relaxed mb-6 font-medium">
          Analysing your investment portfolio for cognitive biases takes under
          10 minutes with NeuFin. Connect your Singapore brokerage or bank
          accounts via the Plaid API, and NeuFin runs multi-model AI analysis
          (Claude, GPT-4, Gemini) across your full transaction history to
          generate a behavioral DNA Score: a 0–100 rating across Disposition
          Effect, Recency Bias, Home Bias, Overconfidence, Herding, and Prospect
          Theory distortions. This guide walks through each step, explains what
          the scores mean, and outlines the actions to take.
        </p>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-6">
            Step-by-Step: Running a Behavioral Bias Analysis
          </h2>
          ...
          <div className="space-y-6">
            {[
              ...
              <div key={step} className="flex gap-4">
                <div
                  className={`w-8 h-8 rounded-full border-2 flex items-center justify-center flex-shrink-0 mt-1 font-bold text-sm ${color} border-current`}
                >
                  {step}
                </div>
                <div>
                  ...
                  <ul className="space-y-2">
                    {content.map((item) => (
                      <li
                        key={item}
                        className="flex items-start gap-2 text-sm text-shell-muted"
                      >
                        <span className="text-shell-subtle mt-1 flex-shrink-0">
                          ›
                        </span>
                        {item}
                      </li>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-3">
            What the Singapore Benchmark Looks Like
          </h2>
          <p className="text-shell-muted leading-relaxed mb-4">
            NeuFin&apos;s Singapore SME benchmark (based on first-time analysis
            results, January–December 2024):
          </p>
            ...
            {[
              {
                bias: "Recency Bias",
                score: "41/100",
                note: "67% worse than global avg",
              },
              {
                bias: "Disposition Effect",
                score: "48/100",
                note: "73% of users affected",
              },
              {
                bias: "Home Bias",
                score: "52/100",
                note: "Avg 51% SGX concentration",
              },
              {
                bias: "Overconfidence",
                score: "62/100",
                note: "Moderate trading frequency",
              },
              {
                bias: "Herding Bias",
                score: "65/100",
                note: "IPO over-participation",
              },
              {
                bias: "Status Quo Bias",
                score: "70/100",
                note: "Lowest impact bias",
              },
            ].map(({ bias, score, note }) => (
              <div
                key={bias}
                className="rounded-lg bg-shell-raised/40 p-3 text-center"
              >
        ...
        <div className="mt-12 rounded-2xl border border-primary/20 bg-primary/5 p-8">
          ...
          <p className="text-shell-muted text-sm mb-5">
            Upload your portfolio CSV or connect via Plaid. Get your Investor
            DNA Score in under 10 seconds. Free — no account required.
          </p>
