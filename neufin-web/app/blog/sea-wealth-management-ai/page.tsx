        ...
        <section className="mb-8">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={num} className="rounded-xl border border-gray-800 bg-gray-900/50 p-5">
        ...
        <section className="mb-8">
          ...
          <div className="grid sm:grid-cols-2 gap-3 mb-4">
            {[
              ...
              <div key={name} className="rounded-lg bg-gray-800/40 p-3">
        ...
        <section className="mb-8">
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={title} className="flex items-start gap-3 p-4 rounded-lg border border-gray-800">
