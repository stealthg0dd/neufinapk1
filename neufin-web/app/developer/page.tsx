...
export default function DeveloperPage() {
      ...
      <div className="mx-auto max-w-5xl space-y-20 px-6 py-section">
        <div className="space-y-6 text-center">
          ...
          <p className="mx-auto max-w-2xl text-xl leading-relaxed text-slate2">
            Embed institutional-grade behavioral finance intelligence into your
            application. 10,000 API calls/day. Production-ready. MAS-aligned.
          </p>
  ...
  -H "X-NeuFin-API-Key: YOUR_API_KEY"`}
          ...
          <p className="text-sm text-muted2">
            The market regime endpoint is free to explore. Full access (DNA
            analysis, swarm, research query) requires an Enterprise plan.
          </p>
        </section>
          ...
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              ...
              <p className="mt-1 text-slate2">
                10,000 API calls/day · All endpoints · Dedicated support
              </p>
            </div>
        ...
        <section className="space-y-4">
          ...
          <p className="text-slate2">
            ...
            <code className="rounded bg-surface-2 px-1 font-mono text-sm text-primary-dark">
              X-NeuFin-API-Key
            </code>{" "}
