        ...
        <div className="w-full max-w-md space-y-4">
            ...
            <div className="card space-y-5 text-center">
              ...
              <div className="h-2 w-full overflow-hidden rounded bg-shell-raised">
                <div
                  ...
                  style={{
                    width: `${Math.min(95, Math.round((attempts / MAX_ATTEMPTS) * 100))}%`,
                  }}
                />
              </div>
          ...
          {reportStatus === "ready" && (
            <div className="card space-y-4 text-center">
              ...
              <Link
                href="/dashboard"
                className="btn-outline block w-full py-3 text-center"
              >
                Return to Dashboard
              </Link>
            </div>
          ...
          {reportStatus === "timeout" && (
            <div className="card space-y-4 text-center">
              ...
              <p className="text-sm text-shell-muted">
                Your report will be emailed to you when ready.
              </p>
              <Link
                href="/dashboard"
                className="btn-outline block w-full py-3 text-center"
