...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "portfolio DNA scoring",
    "AI investment advisor Singapore",
    "MAS fintech",
    "hedge fund analytics retail",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "NeuFin — Agentic Portfolio Intelligence",
      },
    ],
  },
  twitter: {
...
const softwareApplicationSchema = {
  ...
  description:
    "AI-powered portfolio intelligence platform with 7-agent swarm for behavioral finance analysis and IC-grade reporting.",
  offers: {
    "@type": "Offer",
    price: "0",
    priceCurrency: "USD",
...
export const viewport = {
  ...
  initialScale: 1,
  themeColor: [
    { media: "(prefers-color-scheme: light)", color: "#1EB8CC" },
    { color: "#F6F8FB" },
  ],
};
...
gtag('config', '${GA_ID}');`}
        ...
        <link
          rel="preconnect"
          href="https://gpczchjipalfgkfqamcu.supabase.co"
        />
      </head>
      <body
