      ...
      <main className="flex-1 max-w-3xl mx-auto px-6 py-12 w-full">
        <div className="prose prose-invert prose-sm max-w-none">
          ...
          <Section title="1. Overview">
            <p>
              {COMPANY} (&ldquo;Neufin&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;) operates the {APP_NAME}
              web application and mobile app (collectively, the &ldquo;Service&rdquo;). This Privacy Policy
              explains what personal data we collect, why we collect it, how we use it, and the choices you have.
            </p>
            <p>
              By using Neufin you agree to this policy. If you do not agree, please stop using the Service.
            </p>
          </Section>

          <Section title="2. Data We Collect">
            <h3 className="text-white font-semibold mt-4 mb-2">2.1 Portfolio CSV files</h3>
            <p>
              When you upload a CSV file, we read the <code>symbol</code> and <code>shares</code> columns
              to compute your Investor DNA Score. This file is processed in memory and is{' '}
              <strong>never stored on our servers in its raw form</strong>. We store only the aggregated
              result (score, investor type, recommendations) linked to a random share token.
            </p>

            <h3 className="text-white font-semibold mt-4 mb-2">2.2 Account data (optional)</h3>
            <p>
              If you create an account, we collect your <strong>email address</strong> via Supabase Auth.
              You may also optionally provide your name and firm name if you use the advisor features.
              Account creation is not required to use the core DNA analysis.
            </p>

            <h3 className="text-white font-semibold mt-4 mb-2">2.3 Analysis history</h3>
            <p>
              For authenticated users, we store your DNA score history in our Supabase database so you can
              access it across devices. Each record contains: DNA score, investor type, recommendation,
              portfolio total value, and a share token. Individual position data (symbols and share counts)
              is <strong>not retained</strong> after analysis.
            </p>

            <h3 className="text-white font-semibold mt-4 mb-2">2.4 Usage analytics</h3>
            <p>
              We collect anonymised, first-party usage events (e.g. &ldquo;upload started&rdquo;,
              &ldquo;checkout clicked&rdquo;) to understand how the product is used and improve it.
              These events do not contain personal information or portfolio data. We do not use
              Google Analytics or Meta Pixel.
            </p>

            <h3 className="text-white font-semibold mt-4 mb-2">2.5 Payment information</h3>
            <p>
              Payments are processed entirely by <strong>Stripe</strong>. Neufin never sees or stores
            ...
            <p>
              If you arrive via a referral link, we store the referral token in your browser&rsquo;s
              localStorage to apply a discount at checkout. This token is a random 8-character string
              tied to the referrer&rsquo;s share record, not their identity.
            </p>
          </Section>
          ...
          <Section title="3. How We Use Your Data">
            <ul className="space-y-2 text-gray-300">
              ...
              <li><strong className="text-white">Email communications</strong> — if you subscribe to the weekly digest, we send you a periodic email with your latest DNA score context. You can unsubscribe at any time.</li>
              <li><strong className="text-white">Security and fraud prevention</strong> — to detect and prevent abuse of the platform.</li>
            </ul>
          </Section>
              ...
              <table className="w-full text-sm border-collapse">
                ...
                <tbody className="divide-y divide-gray-800/60">
                  {[
                    ...
                    ['Google Gemini', 'AI fallback analysis', 'Portfolio metrics, symbols'],
                    ['OpenAI', 'AI fallback analysis', 'Portfolio metrics, symbols'],
                    ['Groq', 'AI fallback analysis', 'Portfolio metrics, symbols'],
                    ['Stripe', 'Payment processing', 'Email, billing metadata'],
                    ['Finnhub', 'Live stock prices', 'Stock ticker symbols'],
                    ['Alpha Vantage', 'Live stock prices (fallback)', 'Stock ticker symbols'],
          ...
          <Section title="5. Data Retention">
            <ul className="space-y-2 text-gray-300">
              ...
              <li><strong className="text-white">Analytics events</strong> are retained for <strong>12 months</strong> in aggregated form.</li>
              <li><strong className="text-white">Email subscriptions</strong> are retained until you unsubscribe or request deletion.</li>
            </ul>
          </Section>
          ...
          <Section title="6. Your Rights & Data Deletion">
            ...
            <ul className="space-y-2 text-gray-300 mt-3">
              ...
              <li>
                <strong className="text-white">Unsubscribe from emails</strong> — click the unsubscribe
                link in any email, or email us.
              </li>
            </ul>
          </Section>
          ...
          <Section title="7. Cookies & Local Storage">
            ...
            <ul className="space-y-1 text-gray-300 mt-2">
              ...
              <li><code>neufin-auth</code> — Supabase session token (for authenticated users)</li>
              <li><code>neufin_session_id</code> — anonymous session ID for analytics (tab-scoped)</li>
            </ul>
            <p className="mt-3">
              None of this data is shared with third parties. You can clear it at any time via your
              browser&rsquo;s developer tools.
            </p>
          </Section>
          ...
          <Section title="9. Security">
            <p>
              All data in transit is encrypted via TLS 1.2+. Data at rest in Supabase is encrypted
              using AES-256. We use Row Level Security (RLS) policies to ensure users can only access
              their own records. PDF reports are stored in a private Supabase Storage bucket and
          ...
          <Section title="10. Changes to This Policy">
            <p>
              ...
              by updating the &ldquo;Effective date&rdquo; at the top and, for registered users,
