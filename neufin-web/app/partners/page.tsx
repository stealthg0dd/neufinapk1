...
function AgentTraceDots({ active, completedCount }: { active: boolean; completedCount: number }) {
  return (
...
function DnaResultCard({ result }: { result: DemoResult }) {
  ...
  const rec = result.recommendation ?? result.strengths?.[0] ?? 'Portfolio construction is sound.'
...
export default function PartnersPage() {
  ...
  const additionalClients = hoursPerClient > 0 ? Math.floor(savedHours / hoursPerClient) : 0
  ...
  const runDemo = useCallback(async () => {
    ...
    try {
      ...
      const res = await fetch('/api/partners/demo', { method: 'POST', body: formData })
  ...
  return (
    <div style={{ background: '#070D1A', color: '#E2E8F0', fontFamily: 'Inter, system-ui, sans-serif', minHeight: '100vh' }}>
      ...
      <section style={{ maxWidth: 1100, margin: '0 auto', padding: '80px 24px 60px', textAlign: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap' }}>
          <a
            href="#sandbox"
            style={{
              background: '#0EA5E9', color: '#fff', padding: '14px 32px',
        ...
        <div style={{ maxWidth: 900, margin: '0 auto', padding: '64px 24px' }}>
          <div style={{ textAlign: 'center', marginBottom: 40 }}>
            <div style={{
              ...
              padding: '4px 16px', fontSize: 12, color: '#22C55E',
              fontWeight: 600, letterSpacing: 1, textTransform: 'uppercase', marginBottom: 16,
            }}>
          ...
          <div style={{
            ...
            {(demoStatus === 'analyzing' || demoStatus === 'done') && (
              <div style={{ marginTop: 24, borderTop: '1px solid #1E2D45', paddingTop: 20 }}>
                ...
                <AgentTraceDots
                  ...
                  completedCount={demoStatus === 'done' ? AGENT_NAMES.length : completedAgents}
                />
              </div>
            )}
            ...
            {/* Error state */}
            {(demoStatus === 'error' || (demoStatus === 'done' && demoResult?.error)) && (
              <div style={{
                marginTop: 20, background: '#1C0A0A', border: '1px solid #7F1D1D',
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
                {col.tags.map(tag => (
                  <span key={tag} style={{
                    ...
                    color: col.color, borderRadius: 6, padding: '3px 10px', fontSize: 11,
                    fontWeight: 600,
                  }}>
                    {tag}
                  </span>
        ...
        <div style={{ maxWidth: 900, margin: '0 auto', padding: '80px 24px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 40 }}>
            ...
            <div>
              ...
              {[
                { label: 'Active clients', value: clients, setter: setClients, min: 1, max: 5000 },
                { label: 'Average AUM per client ($K)', value: avgAum, setter: setAvgAum, min: 10, max: 50000 },
            ...
            >
              {tier.badge && (
                <div style={{
                  ...
                  background: tier.color, color: '#fff', borderRadius: 20, padding: '3px 14px',
              ...
              <div style={{
                fontSize: 11, color: tier.color, fontWeight: 700, letterSpacing: 2,
        ...
        <div style={{ maxWidth: 900, margin: '0 auto', padding: '80px 24px' }}>
          ...
          <div style={{
            ...
            <div style={{ borderBottom: '1px solid #1E2D45', display: 'flex', position: 'relative' }}>
              ...
              <div style={{ display: 'flex', gap: 4, padding: '8px 8px', marginLeft: 'auto' }}>
      ...
      <section style={{ maxWidth: 1100, margin: '0 auto', padding: '80px 24px', textAlign: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap' }}>
          <Link href="/auth" style={{
            background: '#0EA5E9', color: '#fff', padding: '14px 36px',
            borderRadius: 10, fontWeight: 700, fontSize: 15, textDecoration: 'none',
          }}>
            Start Free Trial
          </Link>
