...
const founders = [
  {
    ...
    tags: ['AI & Machine Learning', 'Cybersecurity', 'Behavioral Finance', 'Risk Systems'],
  },
  {
    name: 'Ha Pham',
    ...
    tags: ['Digital Banking', 'Platform Strategy', 'AI Personalization', 'SEA Markets'],
  },
  {
    name: 'Ray Nee',
...
const markets = [
  { flag: '🇸🇬', name: 'Singapore', status: 'ACTIVE', cls: 'bg-positive/10 text-positive' },
  { flag: '🇲🇾', name: 'Malaysia', status: 'ACTIVE', cls: 'bg-positive/10 text-positive' },
  { flag: '🇦🇪', name: 'UAE', status: '2025', cls: 'bg-warning/10 text-warning' },
  { flag: '🇪🇺', name: 'EU/Estonia', status: 'ACTIVE', cls: 'bg-positive/10 text-positive' },
  { flag: '🇺🇸', name: 'USA', status: '2025', cls: 'bg-warning/10 text-warning' },
  { flag: '🇹🇭', name: 'Thailand', status: '2026', cls: 'bg-muted text-muted-foreground' },
  { flag: '🇻🇳', name: 'Vietnam', status: '2026', cls: 'bg-muted text-muted-foreground' },
] as const
      ...
      <section className="mx-auto grid max-w-4xl gap-12 px-6 py-16 md:grid-cols-2">
        <div>
          ...
          <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
            We built NeuFin because every existing tool tells you WHAT happened — after it happened. No platform
            combines real-time sentiment, behavioral bias detection, and predictive intelligence into one actionable
            system.
          </p>
        ...
        <div>
          <h3 className="text-2xl font-bold text-foreground">NeuFin predicts what matters.</h3>
          <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
            Seven specialized AI agents run simultaneously on your portfolio, each an expert in its domain — from
            macro regime to tax architecture to behavioral bias detection.
          </p>
          <div className="mt-6 space-y-3">
            {[
        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {founders.map((f) => {
              ...
              return (
                <article key={f.name} className="rounded-2xl border border-border bg-surface p-6 text-center">
          ...
          <div className="rounded-xl border border-border bg-surface p-5">
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Estonia, EU — Headquarters</p>
              </div>
              <div>
                <p className="font-semibold text-foreground">🇺🇸 Neufin Inc.</p>
                <p className="text-sm text-muted-foreground">United States — Registered Office</p>
              </div>
            </div>
            <p className="mt-4 text-sm text-muted-foreground">
              <a href="mailto:info@neufin.ai" className="text-primary hover:underline">
                info@neufin.ai
              </a>{' '}
              · www.neufin.ai
            </p>
