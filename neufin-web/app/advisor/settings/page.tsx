...
export default function AdvisorSettingsPage() {
  ...
  const [form, setForm] = useState<
    Omit<AdvisorProfile, "id" | "subscription_tier">
  >({
    advisor_name: "",
    firm_name: "",
    calendar_link: "",
  ...
  function handleField<K extends keyof typeof form>(
    key: K,
    value: (typeof form)[K],
  ) {
    ...
    return (
      <div className="flex min-h-screen flex-col items-center justify-center gap-4 bg-app px-6 text-center text-navy">
        ...
        <p className="text-sm text-muted2">
          You need an account to manage your advisor profile.
        </p>
        <Link
          href="/auth?next=/advisor/settings"
        ...
        >
          ...
          <form onSubmit={handleSave} className="space-y-6">
            ...
            <section className="card space-y-4 ring-1 ring-inset ring-primary/30">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleField("advisor_name", e.target.value)
                    }
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-muted2">
                  Shown as a CTA button when clients view their shared results.
                </p>
              </div>
            </section>
            ...
            <section className="card space-y-4 ring-1 ring-inset ring-primary/30">
              ...
              {/* Logo upload */}
              <div>
                <label className="mb-2 block text-xs text-muted2">
                  Firm Logo
                </label>
                <div className="flex items-center gap-4">
                  {logoPreview ? (
                ...
                <div className="flex items-center gap-3 flex-wrap">
                  ...
                  <div className="flex items-center gap-2 ml-1">
                    <input
                      ...
                      onChange={(e) =>
                        handleField("brand_color", e.target.value)
                      }
              ...
              <div className="flex items-center justify-between pt-1">
                <div>
                  ...
                  <p className="mt-0.5 text-xs text-muted2">
                    Replace Neufin branding with your firm logo and colors in
                    generated reports.
                  </p>
                </div>
                <button
            ...
            <section className="card space-y-3 ring-1 ring-inset ring-primary/30">
              ...
              <div
                ...
                style={{
                  borderColor: `${form.brand_color}40`,
              ...
              >
                {logoPreview ? (
                  ...
                  >
                    {(form.firm_name || form.advisor_name || "?")
                      .charAt(0)
                      .toUpperCase()}
                  </div>
                )}
              ...
              <p className="text-xs text-muted2">
                This card appears on results pages shared via your referral
                link.
              </p>
            </section>
