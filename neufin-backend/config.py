...
STRIPE_PRICE_RETAIL_MONTHLY: str | None = settings.STRIPE_PRICE_RETAIL_MONTHLY
STRIPE_PRICE_ADVISOR_MONTHLY: str | None = settings.STRIPE_PRICE_ADVISOR_MONTHLY
STRIPE_PRICE_ENTERPRISE_MONTHLY: str | None = settings.STRIPE_PRICE_ENTERPRISE_MONTHLY
STRIPE_PRICE_ADVISOR_REPORT_ONETIME: str | None = settings.STRIPE_PRICE_ADVISOR_REPORT_ONETIME
